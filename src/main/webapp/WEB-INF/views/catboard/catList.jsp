...
<div class="container">
    ...
    <div class="main">
                    ...
                    <div class="thumbnail bootsnipp-thumb" style="padding:0;">
                        ...
                        <div style="width: 150px;">
                            ...
                            <div class="text-leftx" style="font-size: 10pt">
                                <span>조회수 <%=catBoard.getViews()%> |</span>
                                <span>추천수 <%=catBoard.getLikes()%></span>
                                <span><%=catBoard.getRegdate().substring(0,10)%></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <%--검색창--%>
        <form name="catList" method="post" action="catList.do">
            <div align="center">
                <table>
                    <tr>
