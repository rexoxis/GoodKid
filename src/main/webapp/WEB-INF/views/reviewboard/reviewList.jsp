...
<%
    ...
    ArrayList<ReviewBoard> reviewLists = (ArrayList)request.getAttribute("reviewLists");
...
<div class="container">
    ...
    <div class="main">
                ...
                <div style="width: 150px; height: 150px; margin: 20px;">
                    <div class="thumbnail bootsnipp-thumb" style="padding:0;">
                        <div class="imgwrap" style="height: 100px;">
                            <a href="reviewView.do?bdno=<%=reviewBoard.getBdno()%>">
                                <img class="danlazy"
                                     src="showimg.do?f=<%=reviewBoard.getFile1()%>"
                        ...
                        <div style="width: 150px;">
                            <div>
                                <span class="text-left" style="overflow: hidden ; text-overflow: ellipsis; white-space: nowrap;  width: 150px; height: auto; display: inline-block;  ">
                                    <%--게시글 상세보기로 넘어가는 링크작성--%>
                                    <a href="reviewView.do?bdno=<%=reviewBoard.getBdno()%>"><%=reviewBoard.getTitle()%></a>
                                </span>
                            </div>
                            <div class="text-leftx" style="font-size: 10pt">
                                <span>조회수 <%=reviewBoard.getViews()%> |</span>
                                <span>추천수 <%=reviewBoard.getLikes()%></span>
                                <span><%=reviewBoard.getRegdate().substring(0,10)%></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <%--검색창--%>
        <form name="revlist" method="post" action="reviewList.do">
            <div align="center">
                <table>
                    <tr>
            ...
            <div class="col-12">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                            <% if(cPage > 10) { %>
                        <li class="page-item">
                            <a class="page-link" href="reviewList.do?cpage=<%=(startPage-10)%>" aria-label="Previous">
                        ...
                        <% } else { %>
                                <li class="page-item"><a class="page-link" href="reviewList.do?cpage=<%=i%>"><%=i%></a></li>
                            <% } %>
                        <% } %>

                       <% if(endPage <= totalPage) { %>
                        <li class="page-item">
                            <a class="page-link" href="reviewList.do?cpage=<%=(endPage+1)%>" aria-label="Next">
